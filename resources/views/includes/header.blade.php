        ...
        <div class="mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a class="block cursor-pointer nav-1-2" href="{{ route('landing.club') }}">Clubs</a>
                    <a class="block cursor-pointer nav-1-2" href="{{ route('landing.player') }}">Players</a>
                    <a class="block cursor-pointer nav-1-2" href="{{ route('landing.manager') }}">Managers</a>
                    <a class="block cursor-pointer nav-1-2" href="{{ route('landing.stadium') }}">Stadium</a>
                </nav>
            </div>
